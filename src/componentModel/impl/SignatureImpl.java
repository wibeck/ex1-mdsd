...
public class SignatureImpl extends MinimalEObjectImpl.Container implements Signature {
	...
	protected EClass eStaticClass() {
		return ComponentModelPackage.Literals.SIGNATURE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentModelPackage.SIGNATURE__NAME, oldName, name));
	}
	...
	public EList<Parameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectResolvingEList<Parameter>(Parameter.class, this, ComponentModelPackage.SIGNATURE__PARAMETERS);
		}
		return parameters;
	}
