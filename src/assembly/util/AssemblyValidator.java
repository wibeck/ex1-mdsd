...
public class AssemblyValidator extends EObjectValidator {
	...
	public boolean validateAssemblyContext(AssemblyContext assemblyContext, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null) result &= validateAssemblyContext_assemblyContextIsPartOfOutwardAssemblyConnectors(assemblyContext, diagnostics, context);
		return result;
	}
	...
	/**
	 * The cached validation expression for the assemblyContextIsPartOfOutwardAssemblyConnectors constraint of '<em>Context</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String ASSEMBLY_CONTEXT__ASSEMBLY_CONTEXT_IS_PART_OF_OUTWARD_ASSEMBLY_CONNECTORS__EEXPRESSION = "\n" +
	...
	/**
	 * Validates the assemblyContextIsPartOfOutwardAssemblyConnectors constraint of '<em>Context</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateAssemblyContext_assemblyContextIsPartOfOutwardAssemblyConnectors(AssemblyContext assemblyContext, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(AssemblyPackage.Literals.ASSEMBLY_CONTEXT,
				 assemblyContext,
				 ...
				 ASSEMBLY_CONTEXT__ASSEMBLY_CONTEXT_IS_PART_OF_OUTWARD_ASSEMBLY_CONNECTORS__EEXPRESSION,
				 Diagnostic.ERROR,
				 DIAGNOSTIC_SOURCE,
				 0);
	}
