 ...
 *        annotation="http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot requiredInterfaceFromServiceThatRequiresIt='self.assemblyContext.instantiates.interfaceServiceMap -&gt;exists(entry | entry.services -&gt; select(service| service.requiredInterfaces \n\t\t-&gt; includes(self.interFace)))  -&gt; notEmpty() and not (self.assemblyContext.instantiates = null)'"
 * @generated
 */
